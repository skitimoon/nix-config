# Auto-generated using compose2nix v0.3.2-pre.
{
  ...
  virtualisation.oci-containers.containers."postiz" = {
    ...
    environment = {
      ...
      "FRONTEND_URL" = "https://yimmy.ddns.net";
      "IS_GENERAL" = "true";
      "JWT_SECRET" = "1fd2e2fc684305ef04834d8a0a43b9d10a95e936c4a5810f845cb338d5b480a6";
      "MAIN_URL" = "https://yimmy.ddns.net";
      "NEXT_PUBLIC_BACKEND_URL" = "https://yimmy.ddns.net/api";
      "NEXT_PUBLIC_UPLOAD_DIRECTORY" = "/uploads";
      "NOT_SECURED" = "true";
      "REDIS_URL" = "redis://postiz-redis:6379";
      "STORAGE_PROVIDER" = "local";
      "UPLOAD_DIRECTORY" = "/uploads";
      "INSTAGRAM_APP_ID" = "1368172351089596";
      "INSTAGRAM_APP_SECRET" = "6d0712be066070fe90d11bd3748fcd19";
      "FACEBOOK_APP_ID" = "630427676656594";
      "FACEBOOK_APP_SECRET" = "265fcdb44ccb6e342d4642a4ec79b144";
    };
    volumes = [
      "postiz_postiz-config:/config:rw"
      "postiz_postiz-uploads:/uploads:rw"
    ];
    ports = [
      "5000:5000/tcp"
    ];
  ...
  systemd.services."podman-postiz" = {
    ...
    partOf = [
      "podman-compose-postiz-root.target"
    ];
    upheldBy = [
      "podman-network-postiz_postiz-network.service"
  ...
  virtualisation.oci-containers.containers."postiz-postgres" = {
    ...
    volumes = [
      "postiz_postgres-volume:/var/lib/postgresql/data:rw"
    ];
    log-driver = "journald";
    extraOptions = [
  ...
  virtualisation.oci-containers.containers."postiz-redis" = {
    image = "redis:7.2";
    volumes = [
      "postiz_postiz-redis-data:/data:rw"
    ];
    log-driver = "journald";
    extraOptions = [
